...
import { Breadcrumb, getBreadcrumb } from "~/ui";

const ShowcasePostPage = () => {
  return (
    <>
      <Breadcrumb items={[getBreadcrumb("showcases")]} />
      <main className="mx-auto w-full px-4 lg:max-w-7xl">
        <h1 className="mb-12 text-center text-6xl font-semibold text-sand-12">
          Showcases
        </h1>
        <Showcases />
      </main>
...
const Showcases = () => {
  ...
  console.log({ postBody: post.map((p) => ({ body: p.body.raw })) });
  return (
